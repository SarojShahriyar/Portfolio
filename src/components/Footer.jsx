            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="flex flex-col md:flex-row gap-x-6 gap-y-6 items-center justify-between">
                    <div className="text-center md:text-left">
                        <p className="text-sm text-gray-400 font-geist">© {new Date().getFullYear()} Saroj S. Iqbal. All rights reserved.</p>
                    </div>
                    <div className="flex items-center gap-6 text-sm text-gray-300 font-geist">
                        ...
                        <a href="mailto:connect@sarojshahriyar.dev" className="hover:text-emerald-400 transition-colors">Email</a>
